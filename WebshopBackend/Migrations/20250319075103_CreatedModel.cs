        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShipFirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShipLastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShipAdd1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShipAdd2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Book_SalePercentage", "SalePercentage BETWEEN 0 AND 100");
                    table.ForeignKey(
